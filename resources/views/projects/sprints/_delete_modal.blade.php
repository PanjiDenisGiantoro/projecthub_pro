{{-- Modal Delete Sprint Confirmation (Task-style) --}}
        ...
        <div class="relative w-full max-w-md bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden z-10 pointer-events-auto my-8"
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="flex items-start gap-3.5">
                    ...
                    <div>
                        <h3 class="text-base sm:text-lg font-bold text-slate-900 dark:text-white">Delete This Sprint?</h3>
                        <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
                            This action will permanently delete <strong class="text-slate-800 dark:text-slate-200 font-semibold" x-text="deleteSprintName"></strong>. Tasks in this sprint will be moved back to the backlog.
                        </p>
                    </div>
                </div>
            ...
            <div class="px-6 py-4 border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 flex items-center justify-end gap-2.5">
                ...
                <button type="button" @click="confirmDeleteSprint()"
                    :disabled="!deleteConfirmChecked || isDeletingSprint"
                    ...
                    <template x-if="isDeletingSprint">
                    ...
                    <span x-text="isDeletingSprint ? 'Deleting...' : 'Yes, Delete Sprint'"></span>
                </button>
            </div>
        </div>
    </div>
