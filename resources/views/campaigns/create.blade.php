        ...
        <form method="POST" action="{{ route('campaigns.store') }}" class="space-y-4">
            ...
            <div>
                ...
                <textarea name="description" rows="2"
                          class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 resize-none">{{ old('description') }}</textarea>
            </div>
            ...
            <div>
                ...
                <textarea name="target" rows="2"
                          class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 resize-none">{{ old('target') }}</textarea>
            </div>
