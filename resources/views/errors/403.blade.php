...
<head>
    ...
    <title>403 — Akses Ditolak | Flovig</title>
    ...
    <style>
        ...
        .fl-pulse-ring {
            ...
            border: 2px solid rgb(248 113 113 / 0.6);
...
<div class="w-full max-w-md fl-card">
    <div class="bg-white rounded-2xl shadow-xl p-8 sm:p-10 text-center">
        ...
        <div class="relative inline-flex items-center justify-center w-24 h-24 mb-6 fl-icon-wrap">
            ...
            <div class="relative w-20 h-20 rounded-full bg-red-50 flex items-center justify-center">
        ...
        <p class="text-6xl sm:text-7xl font-extrabold text-gray-800 tracking-tight leading-none mb-2">403</p>
        <h1 class="text-xl sm:text-2xl font-bold text-gray-800 mb-3">Akses Ditolak</h1>
