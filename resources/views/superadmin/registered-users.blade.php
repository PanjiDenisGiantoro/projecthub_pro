                ...
                <td class="px-6 py-4">
                    ...
                    @else
                        <div class="flex flex-wrap gap-1.5">
                            ...
                            @php
                                $pkgColors = [
                                    'hris'            => 'bg-blue-500/15 text-blue-400 border-blue-500/20',
        ...
        <form method="POST" action="{{ route('superadmin.registered-users.store') }}" class="px-6 py-5 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-3">
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required
                           ...
                           class="w-full bg-slate-800 border border-white/10 rounded-xl px-3 py-2.5 text-sm text-white placeholder-slate-600 focus:outline-none focus:border-blue-500/60 transition-all">
                </div>
                <div class="space-y-1.5">
            ...
            <div class="space-y-2">
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    @php
                        $pkgColors = [
                            'hris'            => ['ring' => 'has-[:checked]:border-blue-500/60 has-[:checked]:bg-blue-500/10', 'icon' => 'text-blue-400 bg-blue-500/20'],
                            'task_management' => ['ring' => 'has-[:checked]:border-blue-500/60 has-[:checked]:bg-blue-500/10',   'icon' => 'text-blue-400 bg-blue-500/20'],
                        ];
                        $clr = $pkgColors[$pkg->slug] ?? ['ring' => 'has-[:checked]:border-blue-500/60 has-[:checked]:bg-blue-500/10', 'icon' => 'text-blue-400 bg-blue-500/20'];
                    @endphp
