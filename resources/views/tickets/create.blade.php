        ...
        <form method="POST" action="{{ route('tickets.store', $project) }}" class="space-y-5" enctype="multipart/form-data"
            ...
            <div>
                ...
                <input type="file" name="attachments[]" multiple
                       class="w-full text-sm border border-gray-300 rounded-lg px-4 py-2.5 file:mr-3 file:py-1.5 file:px-3 file:rounded-md file:border-0 file:bg-blue-50 file:text-blue-700 file:text-sm">
                <p class="text-xs text-gray-400 mt-1">Maks. 5 file, masing-masing maks. 10MB.</p>
            </div>
            <div class="flex gap-3 pt-2">
                <button type="submit" :disabled="submitting"
                        class="bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-6 py-2.5 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
