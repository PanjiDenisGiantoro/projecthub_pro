        ...
        <div class="flex items-center gap-1.5 text-xs text-gray-400 font-medium mb-5">
            ...
            @if($project)
                ...
                <a href="{{ route('projects.show', $project) }}"
                    class="text-gray-600 dark:text-gray-300 font-semibold hover:text-blue-600 transition">{{ $project->name }}</a>
            @endif
            <span>&gt;</span>
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 text-gray-600 text-xs uppercase">
                    <tr>
                        ...
                        @if(!$project)
                        <th class="px-4 py-3 text-left">Proyek</th>@endif
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ $project ? 10 : 11 }}" class="px-4 py-8 text-center text-gray-400">Belum ada tiket.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
