...
<div class="py-4">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center gap-3 mb-6">
        ...
        <a href="{{ route('divisions.create') }}" class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-4 py-2 rounded-lg transition-colors shrink-0">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr>
                    <td colspan="6" class="px-4 py-10 text-center text-gray-400">
                        Belum ada divisi.
                        <a href="{{ route('divisions.create') }}" class="text-blue-600 hover:underline ml-1">Tambah sekarang</a>
                    </td>
                </tr>
                @endforelse
            </tbody>
