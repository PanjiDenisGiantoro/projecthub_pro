    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        <form method="POST" action="{{ route('companies.update', $company) }}" enctype="multipart/form-data" class="space-y-5"
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="col-span-2" x-data="{ preview: @json($company->logo ? Storage::url($company->logo) : null) }">
                    ...
                    <p class="text-xs text-gray-400 mt-1">Opsional. Format JPG/PNG, maks 2MB. Kosongkan untuk pertahankan logo saat ini.</p>
