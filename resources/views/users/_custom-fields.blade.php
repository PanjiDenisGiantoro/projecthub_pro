...
<div class="border border-gray-200 rounded-xl p-4 bg-gray-50">
    <div class="flex items-center justify-between mb-4">
        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wider">Custom Fields</p>
        @if(auth()->user()->hasRole('admin') || auth()->user()->is_super_admin)
        <a href="{{ route('custom-fields.index') }}" class="text-xs text-blue-600 hover:underline">Manage Fields</a>
        @endif
    </div>
    <div class="space-y-4">
